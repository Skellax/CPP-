...
/*   Updated: 2022/09/12 14:42:01 by mfuhrman         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Bureaucrat::signForm(Form const& i)
{
    if (i.isS() == true)
    {
        std::cout << DEFAULT << this->getName() << " signed " << i.getName() << std::endl;
    }
    else
    {
        std::cout << RED << this->getName() << " couldn 't sign " << i.getName() \
